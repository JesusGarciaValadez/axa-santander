...
class Poll extends Model 
{
     ...
     *  @param:     array $info         - information validated to save in DB
     *  @param:     boolean $form       - form validated
     *  @return:    array $response     - Response to operation of save
     */
    public function insertData ( $data ) {
        ...
        try 
        {
            ...
            $data[ 'date_answer' ] = date( 'd-m-Y H:i:s' );
